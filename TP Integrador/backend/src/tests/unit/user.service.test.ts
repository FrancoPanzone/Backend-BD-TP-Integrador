...
describe('UserService - Unit Tests', () => {
  ...
  it('should create a new user and delegate password hashing to repository', async () => {
    ...
    expect(UserRepository.getByEmail).toHaveBeenCalledWith('test@example.com', undefined);
  ...
  it('should get a user by ID', async () => {
    ...
    expect(UserRepository.getById).toHaveBeenCalledWith(1, undefined);
  ...
  it('should update user password', async () => {
    (UserRepository.update as jest.Mock).mockImplementation(async (_id, data) => ({
      ...sampleUser,
      ...data,
    ...
    expect(UserRepository.update).toHaveBeenCalledWith(1, expect.any(Object), undefined);
  ...
  it('should delete a user', async () => {
    ...
    expect(UserRepository.delete).toHaveBeenCalledWith(1, undefined);
  ...
  it('should return false when deleting non-existing user', async () => {
    ...
    expect(UserRepository.delete).toHaveBeenCalledWith(999, undefined);
